            ...
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8" action="/files/{{ $file->id }}" enctype="multipart/form-data" method="post">
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input class="shadow appearance-none border rounded w-full h-48 py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                               name="content"
                               id="content"
                               type="text"
                               value="{{ old('content') ?? $file->content }}">
                    </div>
                    @endif
